class ApiObject(object):
    ...
    def __setattr__(self, name, value):
        if self.__dict__.has_key('_ApiObject__initialised'):
            ...
            elif isinstance(object_attr, ApiListAttribute) and not isinstance(value, ApiListAttribute):
                super(ApiObject, self).__setattr__(name, ApiListAttribute(value))
